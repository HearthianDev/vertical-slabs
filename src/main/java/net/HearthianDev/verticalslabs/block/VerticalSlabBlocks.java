...
public class VerticalSlabBlocks {
  public static final Block VERTICAL_OAK_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.OAK_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_SPRUCE_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.SPRUCE_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_BIRCH_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.BIRCH_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_JUNGLE_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.JUNGLE_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_ACACIA_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.ACACIA_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_DARK_OAK_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.DARK_OAK_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_MANGROVE_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.MANGROVE_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_CHERRY_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_BAMBOO_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.BAMBOO_SLAB).sounds(BlockSoundGroup.BAMBOO_WOOD).hardness(2f));
  public static final Block VERTICAL_BAMBOO_MOSAIC_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.BAMBOO_MOSAIC_SLAB).sounds(BlockSoundGroup.BAMBOO_WOOD).hardness(2f));
  public static final Block VERTICAL_CRIMSON_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
  public static final Block VERTICAL_WARPED_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.WARPED_SLAB).sounds(BlockSoundGroup.WOOD).hardness(2f));
