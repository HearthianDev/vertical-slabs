...
public class PolishedSulfur {
    public static final String ID = "vertical_polished_sulfur_slab";
    public static final Block VERTICAL_SLAB = new VerticalSlabBlock(
        BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_SULFUR_SLAB)
