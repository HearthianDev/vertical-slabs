...
public class StoneBricks {
    public static final String ID = "vertical_stone_brick_slab";
    public static final Block VERTICAL_SLAB = new VerticalSlabBlock(
        BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB)
            ...
            .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MOD_ID, "vertical_stone_brick_slab")))
    );
}
