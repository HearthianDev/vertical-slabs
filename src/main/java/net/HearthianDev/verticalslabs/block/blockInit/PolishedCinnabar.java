...
public class PolishedCinnabar {
    public static final String ID = "vertical_polished_cinnabar_slab";
    public static final Block VERTICAL_SLAB = new VerticalSlabBlock(
        BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_CINNABAR_SLAB)
