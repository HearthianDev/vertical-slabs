...
public class Diorite {
    public static final String ID = "vertical_diorite_slab";
    public static final Block VERTICAL_SLAB = new VerticalSlabBlock(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIORITE_SLAB)
            ...
            .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MOD_ID, "vertical_diorite_slab")))
    );
}
